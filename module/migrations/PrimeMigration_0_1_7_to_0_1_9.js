export class PrimeMigration_0_1_7_to_0_1_9
{
	static async update()
	{
		ui.notifications.info("Migrating world from 0.1.7 (or lower) to version 0.1.9.");
		var success = await this.updateItems()

		if (success)
		{
			const message = "Migration to version 0.1.9 successful, goats were herded."
		...
		{
			const error = "Migration to version 0.1.9 failed, goats were not herded. See console for more details.";
