export class PrimeMigration_0_7_0_and_0_8_0_to_0_10_1
{
    static async update()
    {
        ui.notifications.info("Migrating world to version 0.10.1.");
        this._updateItems().then(()=>
        {
            {
                const message = "Migration to version 0.10.1 successful, goats were herded.";
        ...
        {
            {
                const error = "Migration to version 0.10.1 failed, goats were not herded. See console for more details (maybe).";
    ...
    static async _updateItems()
    {
        const updatePromise = await game.items.updateAll(
            PrimeMigration_0_7_0_and_0_8_0_to_0_10_1._performItemUpdate,
            PrimeMigration_0_7_0_and_0_8_0_to_0_10_1._shouldUpdate
        );
    ...
    static _performItemUpdate(item)
    {
        ...
        {
            updatedItem = PrimeMigration_0_7_0_and_0_8_0_to_0_10_1._updateArmour(updatedItem);
        }
        if (updatedItem.type == "melee-weapon" || updatedItem.type == "ranged-weapon" || updatedItem.type == "shield")
        {
            updatedItem = PrimeMigration_0_7_0_and_0_8_0_to_0_10_1._updateWeapon(updatedItem);
        }
        return updatedItem;
    }
